...
def matcher(kp1, des1, kp2, des2, threshold):
    ...
    for pair in good_index:
        matches.append(list(kp1[pair[0]].pt + kp2[pair[1]].pt))
...
def stitch_img(left, right, H):
    ...
    return stitch_image, translation_mat
...
if __name__=="__main__":
    ...
    # for baseline: 0.6
    # for bonus: 0.4
    matches = matcher(kp_img1, des_img1, kp_img2, des_img2, 0.4)
    matches2 = matcher(kp_img2, des_img2, kp_img3, des_img3, 0.4)
    matches3 = matcher(kp_img3, des_img3, kp_img4, des_img4, 0.4)
    ...
    # merge_img4, A4 = stitch_img(merge_img3, img5_rgb, A1@H@H2@H3@H4)
    # merge_img5, A5 = stitch_img(merge_img4, img6_rgb, A1@H@H2@H3@H4@H5)
